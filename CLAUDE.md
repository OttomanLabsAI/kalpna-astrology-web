...
| v3.3 | The portraits sit still and straight | Kalpna's photographs no longer repeat or crop away on phones — each one now sits exactly where it should, faces in frame, one image per frame. The subtle scroll drift they once had is retired in exchange for photos that always look right. |
